...
class Controller_Haml extends Controller {
	...
	public function after()
	{
		if ($this->auto_render === TRUE)
		{
                    if( ! isset($this->template->content)) // FIXME: added by hands :)
			$this->template->content = Haml::factory($this->request->directory . '/' . $this->request->controller . '/' . $this->request->action, $this->view_data, $this->haml_options);
